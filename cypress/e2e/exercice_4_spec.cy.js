describe("Validations Exercice 4: ", () => {
  ...
  it("Should have 20px margin on main", () => {
    cy.get("main").should("have.css", "margin", "20px");
  });
  ...
  it("Should have aside tag displayed with flex 1", () => {
    cy.get("aside").should("have.css", "flex", "1 1 0%");
  });

  it("Should have section tag displayed with flex 3", () => {
  ...
  it("Should have a shadow on header and footer", () => {
    cy.get("header")
      .should("exist")
      .and("have.css", "box-shadow")
      .and("match", /rgb\(128, 128, 128\) 0px 4px 2px -2px/);
    cy.get("footer")
      .should("exist")
      .and("have.css", "box-shadow")
      .and("match", /rgb\(128, 128, 128\) 0px -4px 2px -2px/);
